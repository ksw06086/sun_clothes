...
<section>
<form action = "h_QnAupdatePro.do" method = "post" name = "h_QnAform" enctype="multipart/form-data">
				...
				<div id = "product">
				    ...
				    <div id = "notice" class = "oneandone">
				    	...
				    	<col style = "width: 85%;">
				    		...
				    		<tr>
				    			<td>제목</td>
				    			<td>${basevo.subject}</td>
				    		</tr>
				    		
				    		<tr>
				    			<td>작성자</td>
				    			<td><b>${basevo.writer}</b></td>
				    		</tr>
				    	</table>
				    </div>
					...
					<table id = "qna">
			    		...
			    		<c:if test="${vo.textType == 'open'}">
			    			<input type = "hidden" id = "userpwd" name = "pwd">
